...
hero:
  ...
  actions:
    ...
    - theme: alt
      text: Leave a Star ⭐
      link: https://github.com/GlitterKill/gemini-mcp-tool-patched
...
features:
  ...
  - icon: 🔐
    title: No keys!
    details: gemini-mcp-tool-patched does not require any extra keys.
  - icon: 🚦
...
For installation and setup instructions, please refer to our [GitHub repository](https://github.com/GlitterKill/gemini-mcp-tool-patched#readme) which contains the most up-to-date installation guide.
